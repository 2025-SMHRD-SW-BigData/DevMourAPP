...
android {
    ...
    defaultConfig {
        ...
        // AWS S3 설정 - 환경 변수에서 가져오거나 기본값 사용
        ...
        buildConfigField("String", "AWS_S3_BUCKET_NAME", "\"${System.getenv("AWS_S3_BUCKET_NAME") ?: "devmour"}\"")
        buildConfigField("String", "AWS_REGION", "\"${System.getenv("AWS_REGION") ?: "ap-southeast-2"}\"")
    }
